...
class MCP4xx1(DigitalPotentiometerDevice, MCP4xxx):
    ...
    def __init__(
        ...
        winder = MCP4xxxWinder(
            potentiometer=potentiometer, spi=self._spi, max_value=max_value
        )
        DigitalPotentiometerDevice.__init__(self, winder=winder, channels=channels)


class MCP4131(MCP4xx1):
    """7-bit, single channel pot with volatile winder"""
...
class MCP4141(MCP4xx1):
    """7-bit, single channel pot with non-volatile winder"""
...
class MCP4151(MCP4xx1):
    """8-bit, single channel pot with volatile winder"""
...
class MCP4161(MCP4xx1):
    """8-bit, single channel pot with non-volatile winder"""
...
class MCP4231(MCP4xx1):
    """7-bit, dual channel pot with volatile winder"""
...
class MCP4241(MCP4xx1):
    """7-bit, dual channel pot with non-volatile winder"""
...
class MCP4251(MCP4xx1):
    """8-bit, dual channel pot with volatile winder"""
